...
Two common issues faced in the analysis of electrophysiology data are dealing with a limited signal-to-noise ratio, and obtaining interpretable results from high-dimensional data [@Cohen2022]. Spatio-spectral decomposition is a multivariate technique that addresses these problems, capturing the key aspects of frequency band-specific information in a high signal-to-noise ratio, low-dimensional space [@Nikulin2011]. This decomposition can be applied for the multivariate analysis of non-sinusoidal waveshape, with extensions like harmonic power maximisation more specifically targetting non-sinusoidal information [@Bartz2019]. `PyBispectra` provides tools for using spatio-spectral filtering to enhance the signal-to-noise ratio and reduce the dimensionality of electrophysiology data.
